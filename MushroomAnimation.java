...
public class MushroomAnimation {
	...
	public MushroomAnimation() {
		...
		Image stripImage = ImageManager.loadImage("images/mushroomChasingLeft.png");
		...
		for (int row = 0; row < spriteRowsChasing; row++) {
			for (int col = 0; col < spriteColumns; col++) {
				...
				g.drawImage(stripImage,
						...
						col * imageWidth, row * imageHeight, (col * imageWidth) + imageWidth, (row * imageHeight) + imageHeight,
						null);

...
public class HealthDisplay {
    ...
    // public void draw(Graphics g, int health, int a) {
    ...
    // }
    // if (halfHearts > 0) {
    // g.drawImage(halfHeart, x + fullHearts * (width + spacing), y, width, height,
    // null);
    // }
    // for (int i = 0; i < emptyHearts; i++) {
    // g.drawImage(emptyHeart, x + (fullHearts + halfHearts) * (width + spacing) + i
    // * (width + spacing), y, width, height, null);
    // }
    // }
    ...
    public void draw(Graphics g, int health, int screenWidth) {
        ...
        for (int i = 0; i < fullHearts; i++) {
            g.drawImage(fullHeart, screenWidth - (i + 1) * (width + spacing), y, width,
                    height, null);
        }
        if (halfHearts > 0) {
            g.drawImage(halfHeart, screenWidth - (fullHearts + 1) * (width + spacing), y,
                    width, height, null);
        }
        for (int i = 0; i < emptyHearts; i++) {
            g.drawImage(emptyHeart, screenWidth - (fullHearts + halfHearts + i + 1) *
                    (width + spacing), y, width,
                    height, null);
        }
    }
